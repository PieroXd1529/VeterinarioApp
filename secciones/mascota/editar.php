...
<?php
   ...
   if(isset($_GET['txtID'])){
    ...
    $sentencia=$conexion->prepare("SELECT * FROM pet WHERE id_pet=:id_pet");
    $sentencia->bindParam(":id_pet",$txtID);
    $sentencia->execute();
    $registro=$sentencia->fetch(PDO::FETCH_LAZY);
    $nom_mas=$registro["nom_mas"];
    ...
    if($_POST){
        ...
        $sentencia=$conexion->prepare("UPDATE  pet  SET  nom_mas=:nom_mas, sexo=:sexo,edad=:edad,
        peso=:peso, observ=:observ,  fecha=:fecha
        where id_pet=:id_pet") ;    
       ...
       if($tmp_foto!=''){
          ...
          $sentencia=$conexion->prepare("SELECT foto FROM `pet` WHERE  id_pet=:id_pet");
          $sentencia->bindParam(":id_pet",$txtID);
          $sentencia->execute();
        ...
        $sentencia=$conexion->prepare("UPDATE  pet  SET foto=:foto  where id_pet=:id_pet") ;  
       ...
       if($tmp_historia!=''){
        ...
        $sentencia=$conexion->prepare("UPDATE  pet  SET historia=:historia  where id_pet=:id_pet") ;  
...
$con = connect();
$txtID = $_GET['txtID'];
$sql = "SELECT pet.id_pet, pet.nom_mas, pet_type.id_type, pet_type.tipo, raza.id_raza, raza.nomraza, pet.sexo, pet.edad,  pet.peso,  pet.observ, pet.estado, pet.fecha FROM pet INNER JOIN pet_type ON pet.id_type =  pet_type.id_type INNER JOIN raza ON pet.id_raza =raza.id_raza   WHERE id_pet= '$txtID'";
$query  =$con->query($sql);
$data =  array();
if($query){
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            class="form-control" readonly name="txtID" id="txtID" aria-describedby="helpId" placeholder="ID">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nom_mas" value="<?php echo $d->nom_mas; ?>"  class="form-control" placeholder="Nombre de la mascota..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file"class="form-control" name="historia" id="historia" aria-describedby="helpId" placeholder="Foto">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="4" value="<?php echo $d->observ; ?>"  name="observ" class="form-control no-resize" placeholder="Observaciones..."><?php echo $d->observ; ?></textarea>
                                        </div>
                                    </div>
                                </div>
