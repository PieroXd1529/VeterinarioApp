...
$con  = new mysqli("localhost","root","","vetedog");
...
$products = $con->query("SELECT productos.id_prod, productos.codigo,productos.foto,productos.nompro, productos.stock, productos.precV, productos.preciC,categoria.id_cate, categoria.nomcate, productos.fecha FROM productos INNER JOIN categoria ON productos.id_cate = categoria.id_cate  where id_prod=$c[id_prod]");
