...
if(isset($_GET['txtID'])){
    ...
    $sentencia=$conexion->prepare("DELETE FROM veterinarios WHERE id=:id");
    $sentencia->bindParam(":id",$txtID);
    $sentencia->execute();
...
$sentencia=$conexion->prepare("SELECT * FROM `veterinarios`");
$sentencia->execute();
$lista_veterinarios=$sentencia->fetchAll(PDO::FETCH_ASSOC);
...
<!--=============================================================CONTENIDO DE LA PÁGINA =============================================================-->
    <section class="content">
        <div class="container-fluid">
            ...
            <tbody>
            <?php foreach($lista_veterinarios as $registro){?>
                <tr class="">
