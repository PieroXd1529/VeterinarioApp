...
<?php
   ...
   if(isset($_GET['txtID'])){
    ...
    $sentencia=$conexion->prepare("SELECT * FROM dueño WHERE id=:id");
    $sentencia->bindParam(":id",$txtID);
    $sentencia->execute();
    $registro=$sentencia->fetch(PDO::FETCH_LAZY);
    $nom_due=$registro["nom_due"];
    $ape_due=$registro["ape_due"];
    $foto=$registro["foto"];
    ...
    if($_POST){
        ...
        $sentencia=$conexion->prepare("UPDATE  dueño  SET  nom_due=:nom_due, ape_due=:ape_due,  movil=:movil, correo=:correo, direccion=:direccion
        where id=:id") ;    
       ...
       if($tmp_foto!=''){
        ...
        $sentencia=$conexion->prepare("UPDATE  dueño  SET foto=:foto  where id=:id") ;  
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            class="form-control" readonly name="txtID" id="txtID" aria-describedby="helpId" placeholder="ID">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                        <input type="text"
         value="<?php echo $nom_due;?>"
           class="form-control" name="nom_due" id="nom_due" aria-describedby="helpId" placeholder="Nombre del Cliente">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                        <input type="text"
         value="<?php echo $ape_due;?>"
           class="form-control" name="ape_due" id="ape_due" aria-describedby="helpId" placeholder="Apellido del Cliente">
                                        </div>
                                    </div>
                                </div>
         ...
         value="<?php echo $movil;?>"
           class="form-control" name="movil" id="movil" aria-describedby="helpId" placeholder="Telefono del Cliente">
                                        </div>
                                    </div>
                                </div>
         ...
         value="<?php echo $correo;?>"
           class="form-control" name="correo" id="correo" aria-describedby="helpId" placeholder="Correo del Cliente">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
