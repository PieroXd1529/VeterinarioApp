...
$sentencia=$conexion->prepare("SELECT * FROM `dueño`");
$sentencia->execute();
$lista_dueños=$sentencia->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="container-fluid">
            ...
            <?php foreach($lista_dueños as $registro){?>
                <tr class="">
                    ...
                    <td >
                        <img width="200" src="<?php echo $registro['foto'];?>" class="img-fluid rounded alt="/>
