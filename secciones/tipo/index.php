...
<?php
    ...
    if(isset($_GET['txtID'])){
        ...
        $sentencia=$conexion->prepare("DELETE FROM pet_type WHERE id_type=:id_type");
        $sentencia->bindParam(":id_type",$txtID);
        $sentencia->execute();
        header("Location:index.php");
    }

    $sentencia=$conexion->prepare("SELECT * FROM `pet_type`");
    $sentencia->execute();
    $lista_tipos=$sentencia->fetchAll(PDO::FETCH_ASSOC);
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                    <?php foreach($lista_tipos as $registro){?>
                <tr class="">
                    <td scope="row"><?php echo $registro['id_type'];?></td>
...
<?php  }   else {?> 
    ...
    <form  method="get" action="javascript:inactivo('<?php echo $registro['id_type']; ?>')"> 
        ...
        <?php  } ?></td> 
                    ...
                    <td><a name="" id="" class="btn btn-info" href="editar.php?txtID=<?php echo $registro['id_type'];?>"  class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
                    <i class="material-icons">autorenew</i>
                </a>
                <a name="" id="" class="btn btn-danger" href="index.php?txtID=<?php echo $registro['id_type'];?>"  class="btn bg-red btn-circle waves-effect waves-circle waves-float">
