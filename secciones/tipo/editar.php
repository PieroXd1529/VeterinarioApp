...
<?php
   ...
   if(isset($_GET['txtID'])){
    ...
    $sentencia=$conexion->prepare("SELECT * FROM pet_type WHERE id_type=:id_type");
   ...
   if($_POST){
    ...
    $sentencia=$conexion->prepare("UPDATE  pet_type  SET  tipo=:tipo, fecha=:fecha
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            class="form-control" readonly name="txtID" id="txtID" aria-describedby="helpId" placeholder="ID">
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label">Nombre del tipo de mascota</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                        <input type="text"
         value="<?php echo $tipo;?>"
           class="form-control" name="tipo" id="tipo" aria-describedby="helpId" placeholder="Nombre del tipo de mascota">
                                        </div>
                                    </div>
                                </div>
