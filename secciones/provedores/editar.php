...
<?php
   ...
   if(isset($_GET['txtID'])){
    ...
    $sentencia=$conexion->prepare("SELECT * FROM provedor WHERE id_prove=:id_prove");
    $sentencia->bindParam(":id_prove",$txtID);
    $sentencia->execute();
    $registro=$sentencia->fetch(PDO::FETCH_LAZY);
    $nomprove=$registro["nomprove"];
    $ruc=$registro["ruc"];
   ...
   if($_POST){
    ...
    $nomprove=(isset($_POST["nomprove"])?$_POST["nomprove"]:"");
    $ruc=(isset($_POST["ruc"])?$_POST["ruc"]:"");
    $direcc=(isset($_POST["direcc"])?$_POST["direcc"]:"");
    $pais=(isset($_POST["pais"])?$_POST["pais"]:"");
    $tele=(isset($_POST["tele"])?$_POST["tele"]:"");
    $corre=(isset($_POST["corre"])?$_POST["corre"]:"");
  
    $sentencia=$conexion->prepare("UPDATE  provedor  SET  nomprove=:nomprove, ruc=:ruc,direcc=:direcc, pais=:pais,tele=:tele, corre=:corre
    where id_prove=:id_prove") ;
  
    $sentencia->bindParam(":id_prove",$txtID);
      
    $sentencia->bindParam(":ruc",$ruc);
    $sentencia->bindParam(":nomprove",$nomprove);
    $sentencia->bindParam(":direcc",$direcc);
    $sentencia->bindParam(":pais",$pais);
    $sentencia->bindParam(":tele",$tele);
    $sentencia->bindParam(":corre",$corre);
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                            <div class="row clearfix">
                                <div class="col-sm-3">
                                    <label class="control-label">ID DEL PROVEDOR</label>
            ...
            class="form-control" readonly name="txtID" id="txtID" aria-describedby="helpId" placeholder="ID">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
            value="<?php echo $ruc;?>"
            class="form-control" readonly name="ruc" id="ruc" aria-describedby="helpId" placeholder="ruc">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nomprove" value="<?php echo $nomprove; ?>"  class="form-control" placeholder="Nombre del proveedor..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="direcc" value="<?php echo $direcc; ?>"  class="form-control" placeholder="Direccion del proveedor..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="pais" value="<?php echo $pais; ?>"  class="form-control" placeholder="Pais del proveedor..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="9" name="tele" value="<?php echo $tele; ?>"  class="form-control" placeholder="Telefono del proveedor..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="email" name="corre" value="<?php echo $corre; ?>"  class="form-control" placeholder="Correo del proveedor..." />
                                        </div>
                                    </div>
                                </div>
