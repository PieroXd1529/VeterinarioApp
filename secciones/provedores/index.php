...
<?php
    ...
    if(isset($_GET['txtID'])){
        ...
        $sentencia=$conexion->prepare("DELETE FROM provedor WHERE id_prove=:id_prove");
        $sentencia->bindParam(":id_prove",$txtID);
        $sentencia->execute();
        header("Location:index.php");
    }

    $sentencia=$conexion->prepare("SELECT * FROM `provedor`");
    $sentencia->execute();
    $lista_provedores=$sentencia->fetchAll(PDO::FETCH_ASSOC);
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                    <?php foreach($lista_provedores as $registro){?>
                <tr class="">
                    <td scope="row"><?php echo $registro['id_prove'];?></td>
                    <td ><?php echo $registro['ruc'];?></td>
                    <td ><?php echo $registro['nomprove'];?></td>
                    <td ><?php echo $registro['corre'];?></td>
                    <td ><?php echo $registro['direcc'];?></td>
...
<td><?php    
                ...
                <form  method="get" action="javascript:activo('<?php echo $registro['id_prove']; ?>')">
                   
                    <span class="label label-success">Activo</span>
                </form>
                <?php  }   else {?> 

                    <form  method="get" action="javascript:inactivo('<?php echo $registro['id_prove']; ?>')"> 
                        <button type="submit" class="btn btn-danger btn-xs">Inactivo</button>
                     </form>
                        <?php  } ?></td> 

<td><a type="button" href="editar.php?txtID=<?php echo $registro["id_prove"]; ?>"  class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
                    <i class="material-icons">autorenew</i>
                </a>
                <a type="button" href="index.php?txtID=<?php echo $registro["id_prove"]; ?>"  class="btn bg-red btn-circle waves-effect waves-circle waves-float">
