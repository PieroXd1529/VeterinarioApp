...
if($_POST){
  ...
  $sentencia=$conexion->prepare("INSERT INTO `servicios` (`id_servi`, `nomservi`, `fecha`) VALUES (NULL, :nomservi, :fecha);");
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nomservi" required class="form-control" placeholder="Nombre del servicio..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date" name="fecha" required class="form-control" placeholder="fecha del servicio..." />
                                        </div>
                                    </div>
                                </div>
