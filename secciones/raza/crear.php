...
if($_POST){
    ...
    $sentencia=$conexion->prepare("INSERT INTO `raza` (`id_raza`, `nomraza`, `estado`,`id_type`) VALUES (NULL, :nomraza, :estado,:id_type);");
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                REGISTRO DE RAZAS
                                <small>Registra cualquier tipo de raza...</small>
                            </h2>
                        </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nomraza" required class="form-control" placeholder="Nombre de la raza..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control show-tick"  name="id_type">
