...
<?php
    ...
    if(isset($_GET['txtID'])){
        ...
        $sentencia=$conexion->prepare("DELETE FROM raza WHERE id_raza=:id_raza");
    ...
    (SELECT tipo from pet_type WHERE pet_type.id_type=raza.id_type limit 1)  as tipo
    FROM `raza`");
    $sentencia->execute();
    $lista_razas=$sentencia->fetchAll(PDO::FETCH_ASSOC);
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                    <?php foreach($lista_razas as $registro){?>
                <tr class="">
                    <td scope="row"><?php echo $registro['id_raza'];?></td>
                    <td ><?php echo $registro['nomraza'];?></td>
