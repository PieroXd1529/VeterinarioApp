...
<?php
   ...
   if(isset($_GET['txtID'])){
    ...
    $sentencia=$conexion->prepare("SELECT * FROM categoria WHERE id_cate=:id_cate");
    $sentencia->bindParam(":id_cate",$txtID);
    $sentencia->execute();
    $registro=$sentencia->fetch(PDO::FETCH_LAZY);
    $nomcate=$registro["nomcate"];
   ...
   if($_POST){
    ...
    $nomcate=(isset($_POST["nomcate"])?$_POST["nomcate"]:"");
    $fecha=(isset($_POST["fecha"])?$_POST["fecha"]:"");
  
    $sentencia=$conexion->prepare("UPDATE  categoria  SET  nomcate=:nomcate, fecha=:fecha
    where id_cate=:id_cate") ;
  
    $sentencia->bindParam(":id_cate",$txtID);
    $sentencia->bindParam(":nomcate",$nomcate);
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                MODIFICAR TIPOS DE MASCOTAS
                                <small>Modificar cualquier tipos de mascotas...</small>
                            </h2>
                        </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                            <div class="row clearfix">
                                <div class="col-sm-3">
                                    <label class="control-label">ID DEL TYPE</label>
            ...
            class="form-control" readonly name="txtID" id="txtID" aria-describedby="helpId" placeholder="ID">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                        <input type="text"
         value="<?php echo $nomcate;?>"
           class="form-control" name="nomcate" id="nomcate" aria-describedby="helpId" placeholder="Nombre de la categoria">
                                        </div>
                                    </div>
                                </div>
                  ...
                  <div class='input-group date' name="fecha">
                     <input type='datetime-local' value="<?php echo $fecha; ?>" name="fecha" class="form-control" />
