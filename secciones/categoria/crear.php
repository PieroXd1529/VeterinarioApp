...
if($_POST){
  ...
  $sentencia=$conexion->prepare("INSERT INTO `categoria` (`id_cate`, `nomcate`, `estado`,`fecha`) VALUES (NULL, :nomcate, :estado,:fecha);");
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <small>Registra cualquier categoria...</small>
                            </h2>
                        </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nomcate" required class="form-control" placeholder="Nombre de la categoria.." />
                                        </div>
                                    </div>
                                </div>
