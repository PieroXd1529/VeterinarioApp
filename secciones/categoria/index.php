...
<?php
    ...
    if(isset($_GET['txtID'])){
        ...
        $sentencia=$conexion->prepare("DELETE FROM categoria WHERE id_cate=:id_cate");
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <tr class="">
                    <td scope="row"><?php echo $registro['id_cate'];?></td>
                    <td ><?php echo $registro['nomcate'];?></td>
                    <td ><?php echo $registro['fecha'];?></td>
                   
<td><?php    

if($registro['estado']==1)  { ?> 
<form  method="get" action="javascript:activo('<?php echo $registro['id_cate']; ?>')">
   
    <span class="label label-success">Activo</span>
</form>
<?php  }   else {?> 

    <form  method="get" action="javascript:inactivo('<?php echo $registro['id_cate']; ?>')"> 
        ...
        <?php  } ?></td> 
                    ...
                    <td><a name="" id="" class="btn btn-info" href="editar.php?txtID=<?php echo $registro['id_cate'];?>"  class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
                    <i class="material-icons">autorenew</i>
                </a>
                <a name="" id="" class="btn btn-danger" href="index.php?txtID=<?php echo $registro['id_cate'];?>"  class="btn bg-red btn-circle waves-effect waves-circle waves-float">
